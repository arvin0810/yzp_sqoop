...
public class AvroSchemaGenerator {
  ...
  public Schema generate(String schemaNameOverride) throws IOException {
    ...
    for (String columnName : columnNames) {
      ...
      List<Integer> columnInfoList = columnInfo.get(columnName); // c_real=[3,32,8]
      ...
      // returned [null, string] for decimal, real, double,
      // and float
  ...
  private Type toAvroType(String columnName, int sqlType) {
    ...
    // the implementor of connManager, here is class org.apache.sqoop.manager.MySQLManager
    // eventually call connManager.toAvroType
